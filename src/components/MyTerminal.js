...
export default class MyTerminal extends Component {
  ...
  heroFront = async (upcId) => {
          var self = this;
	  var player;
          self.setState({player: "Loading media..."});
