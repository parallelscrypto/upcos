    ...
    return (
      ...
      <Terminal
		    ...
		    description: '<p style="color:hotpink;font-size:1.1em">** Approve UPC Band Radio to spend 50 of your OneAfrika.  After you have spent 50, you must run approve again.    You MUST run this command FIRST or all of your `colonize` and `own` commands will fail. Visit <a href="upc://000000000011">[[000000000011]]</a> to view a video tutorial on approve **</p>',
              fn: () => {
                ...
                this.setState({ isProgressing: true }, () => {
                  ...
                  approval.then((value) => {
		     terminal.pushToStdout(`You have approved UPC Band Radio to transfer sufficient OneAfrika from your wallet when you buy an NFT.  This approval is good for 50 NFTs.  After you have bought 50, you must run this command again, or your 'colonize' and 'colonizeb' commands will fail`)
                     // expected output: "Success!"
                  });
                })
		...
		terminal.pushToStdout(`Processing approval. Check the activity tab for detailed info`)
            ...
            step0t: {
              ...
              fn: () => {
                ...
                this.setState({ isProgressing: true }, () => {
                  ...
                  approval.then((value) => {
                     terminal.pushToStdout(`You have approved UPC Band Radio to transfer sufficient OneAfrika from your wallet when you buy an NFT.  This approval is good for 50 NFTs.  After you have bought 50, you must run this command again, or your 'hack' and 'hackb' commands will fail`)
                     // expected output: "Success!"
                  });
                })
            ...
            step0u: {
              ...
              fn: () => {
                ...
                this.setState({ isProgressing: true }, () => {
                  ...
                  approval.then((value) => {
                     terminal.pushToStdout(`You can now swap your OneAfrika tokens for UPCStable using the 'upcs' command.  If you want 5 upcs, you need 25 OneAfrika as there is a 5:1 exchange ratio.  The command to swap 25 OneAfrika for 5 UPCS would be 'upcs 5000000000000000000'`)
                     // expected output: "Success!"
                  });
                })
            ...
            bal: {
               description: '<p style="color:hotpink;font-size:1.1em">** Display your OneAfrika balance **</p>',
               fn: () => {
                 this.setState({progressBal: ''});
                 this.setState({ isProgressing: true }, () => {
             ...
             swap: {
                     description: '<p style="color:hotpink;font-size:1.1em">** OneAfrika is the token used to write [[intel]] to UPC codes.  In order to acquire OneAfrika, you must run the `swap` command. This will `swap` Polygon that you have purchased likely from an exchange for OneAfrika from our Decentralized Mint.  No KYC or middleman required.  Specify the amount of OneAfrika that you would like to exchange for the Polygon in your wallet in wei.  This will trigger a transaction that will mint equiv. OneAfrika for Polygon 1:1.  Example: to buy 5 OneAfrika type `swap 5000000000000000000`. In other words, this would send 5 Polygon from your wallet for 5 OneAfrika from the OneAfrika mint.  Visit <a href="upc://000000000010">[[000000000010]]</a> to view a video tutorial on swap</p>',
               fn: (amount) => {
                 this.setState({progressBal: ''});
                 this.setState({ isProgressing: true }, () => {
                   ...
                   approval.then((value) => {
                      ...
                      terminal.pushToStdout(`You have just swapped Polygon for OneAfrika.  Check your Activity tab below to track the transaction. \n  Type 'bal' to see your new balance! Balances can sometimes take minutes to update.  THANK YOU! ${approval}`)
                          terminal.pushToStdout(`[[/swap]]`);
                      // expected output: "Success!"
                   });
...
console.log("location is " + currentUrl);
		  ...
		  var self = this;
		   ...
		   .then(data => {
            ...
            mine: {
              description: '<p style="color:hotpink;font-size:1.1em">** Mine some OneAfrika</p>',
              fn: () => {
                this.setState({progressBal: ''});
                this.setState({ isProgressing: true }, () => {
                  const terminal = this.progressTerminal.current
